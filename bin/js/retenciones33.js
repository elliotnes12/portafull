...
var tasaIEPS = "";
var noObjIva = 0;
var aportacionODepositoArr = new Array();
...
function retencionesToJSON() {
	...
	var planesderetiro11 = validarPlanesDeRetiro11();
	if (planesderetiro11 != null) {
		if (retenciones.complemento == undefined) {
			retenciones.complemento = new Object();
		}
		retenciones.complemento.planesderetiro11 = new Object();
		retenciones.complemento.planesderetiro11 = planesderetiro11;
	}
...
function validarPlanesDeRetiro11() {
	if ($('#sistemaFinanc11').val() != "" && $('#montIntRealesDevengAniooInmAnt11').val() != "" && $('#huboRetirosAnioInmAntPer11').val() != "" && $('#huboRetirosAnioInmAnt11').val() != "") {
		arrPlanesDeRetiro11 = new Object();
		arrPlanesDeRetiro11.sistemaFinanc = $('#sistemaFinanc11').val();
		if ($('#montTotAportAnioInmAnterior11').val() != ""){
			arrPlanesDeRetiro11.montTotAportAnioInmAnterior = $('#montTotAportAnioInmAnterior11').val();
		}
		else{
			arrPlanesDeRetiro11.montTotAportAnioInmAnterior = null;
		}
				
		arrPlanesDeRetiro11.montIntRealesDevengAniooInmAnt = $('#montIntRealesDevengAniooInmAnt11').val();
		arrPlanesDeRetiro11.huboRetirosAnioInmAntPer = $('#huboRetirosAnioInmAntPer11').val();
		if ($('#montTotRetiradoAnioInmAntPer11').val() != ""){
			arrPlanesDeRetiro11.montTotRetiradoAnioInmAntPer = $('#montTotRetiradoAnioInmAntPer11').val();
		}
		else{
			arrPlanesDeRetiro11.montTotRetiradoAnioInmAntPer = null;
		}
		if ($('#montTotExentRetiradoAnioInmAnt11').val() != ""){
			arrPlanesDeRetiro11.montTotExentRetiradoAnioInmAnt = $('#montTotExentRetiradoAnioInmAnt11').val();
		}
		else{
			arrPlanesDeRetiro11.montTotExentRetiradoAnioInmAnt = null;
		}
		if ($('#montTotExedenteAnioInmAnt11').val() != ""){
			arrPlanesDeRetiro11.montTotExedenteAnioInmAnt = $('#montTotExedenteAnioInmAnt11').val();
		}
		else{
			arrPlanesDeRetiro11.montTotExedenteAnioInmAnt = null;
		}
				
		arrPlanesDeRetiro11.huboRetirosAnioInmAnt = $('#huboRetirosAnioInmAnt11').val();
		if ($('#montTotRetiradoAnioInmAnt11').val() != ""){
			arrPlanesDeRetiro11.montTotRetiradoAnioInmAnt = $('#montTotRetiradoAnioInmAnt11').val();
		}
		else{
			arrPlanesDeRetiro11.montTotRetiradoAnioInmAnt = null;
		}
		if ($('#numReferencia11').val() != ""){
			arrPlanesDeRetiro11.numReferencia = $('#numReferencia11').val();
		}
		else{
			arrPlanesDeRetiro11.numReferencia = null;
		}
		if (aportacionODepositoArr.length > 0){
			arrPlanesDeRetiro11.aportacionesODepositos = new Object();
			arrPlanesDeRetiro11.aportacionesODepositos = aportacionODepositoArr;
	      }
		
					
		return arrPlanesDeRetiro11;
	}
	return null;
}
...
function validarRetenciones() {
	...
	if ( $('#montTotRetiradoAnioInmAntPer11').val() != ""){
    	if ( $('#montTotExentRetiradoAnioInmAnt11').val() == ""){
            alert("Debe proporcionar el campo Monto Total Exento del Retiro");
            $('#montTotExentRetiradoAnioInmAnt11').focus();
            return false;
          } 
    	if ( $('#montTotExedenteAnioInmAnt11').val() == ""){
            alert("Debe proporcionar el campo Monto Total Excedente del Monto Exento del Retiro");
            $('#montTotExedenteAnioInmAnt11').focus();
      	  	return false;
          } 
    	if ( eval($('#montTotRetiradoAnioInmAntPer11').val()) != eval($('#montTotExentRetiradoAnioInmAnt11').val())+eval($('#montTotExedenteAnioInmAnt11').val())){
            alert("El valor del campo Monto Total del Retiro no es igual a la suma de los campos Monto Total Exento del Retiro y Monto Total Excedente del Monto Exento del Retiro");
            $('#montTotRetiradoAnioInmAntPer11').focus();
      	  	return false;
          } 
    }
...
function getFolio() {
	$.get('/CFDI33/rest/comprobante/folioRet/', function(response) {
...
$('#addAportacionODeposito').click(function(){
	  if (validaAportacionODeposito() == true){
	    var aportacionODeposito = new Object();
	    aportacionODeposito.tipoAportacionODeposito = $('#tipoAportacionODeposito').val();
	    aportacionODeposito.tipoAportacionODepositoDesc = $('#tipoAportacionODeposito option:selected').text();
	    aportacionODeposito.montAportODep = $('#montAportODep').val();
	    
	    if ( $('#rfcFiduciaria').val() == ""){
	    	aportacionODeposito.rfcFiduciaria = null;
	      }
	      else{
	    	  aportacionODeposito.rfcFiduciaria = $('#rfcFiduciaria').val();
	      }
	    
	    
	         
	    aportacionODepositoArr.push(aportacionODeposito);
	    alert("Aportación o Depósito Agregado.");
	    graficarAportacionODeposito();
	    $('select[name=tipoAportacionODeposito]').val('');
	    $('input[name=montAportODep]').val('');
	    $('input[name=rfcFiduciaria]').val('');
	  }
	})
	
function validaAportacionODeposito(){
    if ( $('#tipoAportacionODeposito').val() == ""){
      alert("Debe seleccionar el campo Tipo de Aportación o Depósito");
      $('#tipoAportacionODeposito').focus();
	  return false;
    }
    if ( $('#montAportODep').val() == ""){
    	alert("Debe proporcionar el campo Monto de Aportación o Depósito");
        $('#montAportODep').focus();
  	  	return false;
      } 
    if (aportacionODepositoArr.length > 0){
    	var tipoAportacionODepositoAux = aportacionODepositoArr[0].tipoAportacionODeposito; 
    	for(i=0;i<aportacionODepositoArr.length;i++) {
    		if (tipoAportacionODepositoAux == aportacionODepositoArr[i].tipoAportacionODeposito){
    			alert("El valor de cada uno de los atributos TipoAportacionODeposito debe ser diferente entre si");
    			$('#tipoAportacionODeposito11').focus();
	      	  	return false;
    		}
    	}
    }
...
function graficarAportacionODeposito() {

	$('#tablaAportacionODeposito tbody').html('');
	if(aportacionODepositoArr.length > 0) {
		$('#tablaAportacionODeposito').show();
	} else {
		$('#tablaAportacionODeposito').hide();
	}
  $.each(aportacionODepositoArr, function(key, concepto) {
		var row = '<tr>';
		
		row += '<td>' + concepto['tipoAportacionODepositoDesc'] + '</td>';
		row += '<td>' + concepto['montAportODep'] + '</td>';
		if (concepto['rfcFiduciaria'] != null)
			row += '<td>' + concepto['rfcFiduciaria'] + '</td>';
		else
			row += '<td></td>';
    
		row += '<td><a class="eliminarAportacionODeposito" onClick="eliminarAportacionODeposito(' + key
				+ ')" id="uuid-' + key
				+ '"><i class="icon-remove"></i> Eliminar </a></td></tr>';


		$('#tablaAportacionODeposito').append(row);
  }); 

}

function eliminarAportacionODeposito(id) {
	aportacionODepositoArr.splice(id, 1);
	graficarAportacionODeposito();
}