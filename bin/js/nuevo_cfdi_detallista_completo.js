...
$.ajax({
  url: "http://portal.expidetufactura.com.mx/ws/numero_a_letra_ireport.php?numero=" + $('input[name=total]').val(),
  async: false,
  dataType: 'plain',
...
detallista.specialInstruction = new Object();
var text = new Object();
text.value = valor;
detallista.specialInstruction.text = new Array();
detallista.specialInstruction.text.push(text);
...
detallista.orderIdentification.ReferenceDate = new Object();
detallista.orderIdentification.ReferenceDate.value = $('#orderDate').val();
...
*/
	...
	if (mapImpuestosTraslados.length == 0 &&(comprobante.impuestos.totalImpuestosRetenidos == undefined || comprobante.impuestos.totalImpuestosRetenidos == 0)) {
		comprobante.impuestos = new Object();
	}
