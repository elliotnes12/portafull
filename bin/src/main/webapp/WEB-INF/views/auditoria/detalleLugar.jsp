...
<c:set var="formAction" value="${contextPath}/lugar/" scope="request" />
...
<div class="container">
	<ul class="breadcrumb">
	  ...
	  <li class="active">LugarExpedicion / Detalle</li>
	</ul>
	<h2>Valor Actual</h2>
	<jsp:include page="/WEB-INF/views/lugarExpedicion/form.jsp" />
	<h2>Valor Anterior</h2>
	<jsp:include page="/WEB-INF/views/auditoria/lugarAnterior.jsp"/>	
</div>