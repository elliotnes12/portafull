...
public class ReceptorNomina12 {
	...
	private List<SubContratacionNomina12> subContratacion;
	
	public ReceptorNomina12() {
	...
	public List<SubContratacionNomina12> getSubContratacion() {
		return subContratacion;
	}

	public void setSubContratacion(List<SubContratacionNomina12> subContratacion) {
