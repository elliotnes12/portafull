...
public class ConsumoDeCombustibles11 {
	...
	private ConceptosConsumoComb conceptos;
	...
	@XmlElement(name = "ConceptosConsComb" )
	public ConceptosConsumoComb getConceptos() {
		return conceptos;
	}

	public void setConceptos(ConceptosConsumoComb conceptos) {
