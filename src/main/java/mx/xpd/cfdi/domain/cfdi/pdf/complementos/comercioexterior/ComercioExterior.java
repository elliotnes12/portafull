...
import mx.xpd.cfdi.domain.cfdi.pdf.complementos.comercioexterior.Destinatario;
import mx.xpd.cfdi.domain.cfdi.pdf.complementos.comercioexterior.EmisorComercioExterior;
import mx.xpd.cfdi.domain.cfdi.pdf.complementos.comercioexterior.Mercancias;
import mx.xpd.cfdi.domain.cfdi.pdf.complementos.comercioexterior.Propietario;
import mx.xpd.cfdi.domain.cfdi.pdf.complementos.comercioexterior.ReceptorComercioExterior;
...
public class ComercioExterior {
	...
	private EmisorComercioExterior emisor;
	private List<Propietario> propietario;
	private ReceptorComercioExterior receptor;
	...
	public EmisorComercioExterior getEmisor() {
		return emisor;
	}

	public void setEmisor(EmisorComercioExterior emisor) {
		this.emisor = emisor;
	}
	...
	public ReceptorComercioExterior getReceptor() {
		return receptor;
	}

	public void setReceptor(ReceptorComercioExterior receptor) {
