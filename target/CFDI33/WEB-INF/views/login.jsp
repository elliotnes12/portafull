    ...
    <body>
        <div class="header">
            <div class="small-12 medium-6 large-6 columns">
                ...
                <div class="small-12 medium-6 large-6 columns">
                	<div style="margin:auto;width: 50%">
                    <a href="<%= URLConstants.INFO_RECOMIENDA %>">
                        <img src="<c:url value="/static/resources/img/Dalevalor.png"/>" style="display: block;margin: auto;">
                    </a>
                    </div>
                </div>
        </div>
        <div align="center" style="margin: auto;max-width: 400px">
	        <img src="<c:url value="/static/resources/img/AnuncioFronteraNorte.jpg"/>" alt="IVA 8%">
        </div>
                ...
                <div class="small-7 medium-5 small-centered medium-centered columns">
                    ...
                    <div class="login">
                        ...
                        <form id="login-form" action="<c:url value='/j_spring_security_check'/>" method='POST'>
                            ...
                            <input type="hidden" placeholder="origen" value="default" id="origen" name="origen">
