    ...
    <body onload='document.login.rfc.focus();'>
        <div class="container">
            ...
            <form id="login" name='login' class="form-signin" action="/CFDI33/usuario/password2" method='POST'>
                ...
                <input type="text" class="input-block-level" id="codigoRescate" name="codigoRescate" placeholder="Código de Rescate">
                ...
                <br />
                <div style="width: 100%">
                    <input class="btn btn-large btn-primary" name="submit" type="submit" value="Generar Contraseña" style="width: inherit;" />
                </div>
