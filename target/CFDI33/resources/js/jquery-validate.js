...
$.extend($.validator, {
	...
	messages: {
		...
		*/
		...
		remote: "Por favor corrije el valor de este campoPlease fix this field.",
		email: "Ingresa una dirección de correo válida.",
		url: "Ingresa una URL válida.",
		date: "Ingresa una fecha válida.",
		dateISO: "Ingresa una fecha válida (ISO).",
		number: "Ingresa un numero válido.",
		digits: "Ingresa sólo letras.",
		creditcard: "Ingresa un número de tarjeta de credito válido.",
		...
		rangelength: $.validator.format("Por favor ingresa un valor entre {0} y {1} caracteres de longitud."),
